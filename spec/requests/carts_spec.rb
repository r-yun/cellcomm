...
# figure out why before context does not work for authentication_path (know that shouldn't work for multi-examples but should work for one example describes)
# look to refactor rest of tests, similar to how refactored this one (use post whenever possible vs. creating new objects)
# FactoryGirl fixture
# do not need describe but just context and it google open source
